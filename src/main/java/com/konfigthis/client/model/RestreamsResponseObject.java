...
public class RestreamsResponseObject {
  ...
  public RestreamsResponseObject() {
  }
  ...
  **/
   ...
   * @return the RestreamsResponseObject instance itself
   */
  public RestreamsResponseObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, restreamsResponseObject.name) &&
        ...
        Objects.equals(this.additionalProperties, restreamsResponseObject.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RestreamsResponseObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RestreamsResponseObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RestreamsResponseObject is not found in the empty JSON string", RestreamsResponseObject.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RestreamsResponseObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RestreamsResponseObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RestreamsResponseObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RestreamsResponseObject.class));

       return (TypeAdapter<T>) new TypeAdapter<RestreamsResponseObject>() {
           @Override
           public void write(JsonWriter out, RestreamsResponseObject value) throws IOException {
           ...
           @Override
           public RestreamsResponseObject read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RestreamsResponseObject instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RestreamsResponseObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RestreamsResponseObject
  * @throws IOException if the JSON string is invalid with respect to RestreamsResponseObject
  */
  public static RestreamsResponseObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RestreamsResponseObject.class);
  }

 /**
  * Convert an instance of RestreamsResponseObject to an JSON string
  *
  * @return JSON string
  */
