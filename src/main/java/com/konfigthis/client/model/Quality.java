...
public class Quality {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "_720P", value = "The quality of the video you have, in pixels. Choices include 360p, 480p, 720p, 1080p, and 2160p.")
  ...
  **/
   ...
   * @return the Quality instance itself
   */
  public Quality putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, quality.type) &&
        Objects.equals(this.quality, quality.quality) &&
        Objects.equals(this.status, quality.status)&&
        Objects.equals(this.additionalProperties, quality.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, quality, status, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Quality>() {
           ...
           public Quality read(JsonReader in) throws IOException {
             ...
             Quality instance = thisAdapter.fromJsonTree(jsonObj);
