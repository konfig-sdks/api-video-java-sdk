...
public class CaptionsListResponse {
  ...
  **/
   ...
   * @return the CaptionsListResponse instance itself
   */
  public CaptionsListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, captionsListResponse.data) &&
        ...
        Objects.equals(this.additionalProperties, captionsListResponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (String requiredField : CaptionsListResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Caption.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CaptionsListResponse>() {
           ...
           public CaptionsListResponse read(JsonReader in) throws IOException {
             ...
             CaptionsListResponse instance = thisAdapter.fromJsonTree(jsonObj);
